...
function download_and_unzip(hostname, name) {
    Java.perform(function() {
        ...
        AssertUtil.A08.implementation = function(x) {}
        AssertUtil.A09.implementation = function(x) {}
        ...
        console.log("Response code is " + mediaDownloadResponse.A2i()); // getResponseCode()

        filterManager.A0C(mediaDownloadResponse, name, 0); // unzip()
