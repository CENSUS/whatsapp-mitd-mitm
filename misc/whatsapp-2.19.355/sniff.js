Java.perform(function() {
    ...
    var PROTOCOL_TREE_NODE_READER = "X.38R";
    var PROTOCOL_TREE_NODE_WRITER = "X.38S";
    var PROTOCOL_TREE_NODE = "X.1Rx";
    ...
    ProtocolTreeNodeReader.A8X.implementation = function() {
        var protocolTreeNode = this.A8X();
        console.log(">>> IN\n" + protocolTreeNodeToString(protocolTreeNode));
        return protocolTreeNode;
    }

    // ProtocolTreeNodeWriter.writePacket()
    ProtocolTreeNodeWriter.AKX.implementation = function(protocolTreeNode, unknown) {
        console.log("<<< OUT\n" + protocolTreeNodeToString(protocolTreeNode));
        return this.AKX(protocolTreeNode, unknown);
    }
});
