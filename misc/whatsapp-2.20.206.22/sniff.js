Java.perform(function() {
    ...
    var PROTOCOL_TREE_NODE_READER = "X.0HZ";
    var PROTOCOL_TREE_NODE_WRITER = "X.0Hb";
    var PROTOCOL_TREE_NODE = "X.0Nf";
    ...
    ProtocolTreeNodeReader.ADk.implementation = function() {
        var protocolTreeNode = this.ADk();
        console.log(">>> IN\n" + protocolTreeNodeToString(protocolTreeNode));
        return protocolTreeNode;
    }

    // ProtocolTreeNodeWriter.writePacket()
    ProtocolTreeNodeWriter.AXJ.implementation = function(protocolTreeNode, unknown) {
        console.log("<<< OUT\n" + protocolTreeNodeToString(protocolTreeNode));
        return this.AXJ(protocolTreeNode, unknown);
    }
});
